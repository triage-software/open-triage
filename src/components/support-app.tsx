        ...
        {helpOpen && (
          <div className="modal-backdrop">
            ...
            >
              ...
              <p>
                To lokalny panel. Skrzynka test@sellersk.it odbiera prawdziwe
                maile przez IMAP, co 30 sekund. Skrzynki info@panelpro.pl i
                info@sellersk.it czekają na podłączenie. Odpowiedzi są wysyłane
                z test@sellersk.it, z kopią w folderze Wysłane wspólnej skrzynki.
...
function MailboxSyncNotice({ mailboxId }: { mailboxId?: string }) {
  ...
  async function checkMail() {
    ...
    try {
      ...
      toast("Skrzynka test@sellersk.it jest aktualna.");
    } catch (error) {
  ...
  return (
    <div className="mailbox-notice" role="status">
      <Mail size={16} />
      <span>
        <strong>test@sellersk.it</strong> — {sync?.status === "connected"
